...
const category = () => {
    ...
    const searchfunction = (type, pages) => {
        if (type === "search") {
            ...
            dispatch(companycouponslist(0, pages, limit, "", companyUpdateDrop?.value, storeUpdateDrop?.value, currentUser?.token))
        }
        if (type === "prev") {
            setPage(page - 1)
            // dispatch(AdminCategoryListURL(page - 1, search, limit, currentUser?.data?.uuid, storeDrop))
            dispatch(companycouponslist(page - 1, search, limit, "", companyUpdateDrop?.value, storeUpdateDrop?.value, currentUser?.token))
        }
        else if (type === "next") {
            setPage(page + 1)
            // dispatch(AdminCategoryListURL(page + 1, search, limit, currentUser?.data?.uuid, storeDrop))
            ...
            dispatch(companycouponslist(page, search, limit, "", companyUpdateDrop?.value, storeUpdateDrop?.value, currentUser?.token))
            ...
            dispatch(companycouponslist(page + 2, search, limit, "", companyUpdateDrop?.value, storeUpdateDrop?.value, currentUser?.token))
            ...
            dispatch(companycouponslist(0, search, pages, "", companyUpdateDrop?.value, storeUpdateDrop?.value, currentUser?.token))
