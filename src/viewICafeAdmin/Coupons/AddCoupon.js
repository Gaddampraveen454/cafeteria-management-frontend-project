...
import { companyAddCoupon } from 'Redux/IcafeAdminRedux/CouponsRedux/coponscompanyredux';
...
const addcategory = () => {
    ...
    const Addcoupon = (event) => {
        ...
        dispatch(companyAddCoupon(payload, currentUser.token))
                            ...
                            <Form onSubmit={Addcoupon}>
                                <Row className="g-3">
                                    ...
                                    <Col xs="12" md="4" >
                                        ...
                                        <Form.Control className="text-alternate" placeholder="Enter" name="name" onChange={(e) => setDescription(e.target.value)} />
                                    </Col>
