...
useEffect(()=>{
  ...
  const AddConsumer = () => {
    ...
    dispatch(iCafeAdminConsumerAddURL(payload, currentUser.token))
  ...
  return (
    <>
      ...
      <div className="page-title-container">
        <NavLink className="muted-link pb-1 d-inline-block hidden breadcrumb-back mb-2" to="/user_management">
