...
import { consumerListURL, iCafeAdminConsumerAddURL, consumerUpdateURL } from 'Redux/IcafeAdminRedux/ICafeAdminUserManagement/adminuserredux';
...
import { ICafeAdminCategoryDropDownListURL, ICafeAdminCategoryStoreDropDownList } from 'Redux/IcafeAdminRedux/CategoryManagement/admincategorymanagementredux';
import { RolesAddURL } from 'Redux/IcafeAdminRedux/AdminRoles/rolesredux';
...
const addroles = () => {
    ...
    //   const { AdmincategoryDropdown } = useSelector((state)=>state.admincategory)
    // console.log(AdmincategoryDropdown,'sbdvhjsdvsdv')


    const { categoryData, AdmincategoryDropdown, storeDropdown, storeDropdownByCompanyId } = useSelector((state) => state.admincategory)
    ...
    const AddConsumer = () => {
        ...
        dispatch(RolesAddURL(payload, currentUser.token))
    ...
    return (
        <>
            ...
            <div className="page-title-container">
                <NavLink className="muted-link pb-1 d-inline-block hidden breadcrumb-back mb-2" to="/roles_list">
                    <CsLineIcons icon="chevron-left" size="20" />
                    <span className="align-middle text-medium ms-1">Roles</span>
                </NavLink>
