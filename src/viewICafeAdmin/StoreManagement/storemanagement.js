...
const StoreManagement = () => {
    ...
    const searchfunction = (type, pages) => {
        ...
        if (type === "search") {
            ...
            setSearch(pages)
            setPage(0)
            dispatch(ICafeAdminStoreListURL(0, pages, currentUser.token, limit, option))
        }
        if (type === "prev") {
            setPage(page - 1)
            dispatch(ICafeAdminStoreListURL(page - 1, search, currentUser.token, limit, option))
        }
        else if (type === "next") {
            setPage(page + 1)
            dispatch(ICafeAdminStoreListURL(page + 1, search, currentUser.token, limit, option))
            ...
            setPage(page + 2)
            dispatch(ICafeAdminStoreListURL(page + 2, search, currentUser.token, limit, option))
        }
        else if (type === "limit") {
            setLimit(pages)
            setPage(0)
    ...
    return (
        <>
            ...
            <Row className="mb-3">
                ...
                <Col lg='3' md='5' xs='12' className="mb-1">
