...
import { companyAddCoupon, companyUpdateCoupon } from 'Redux/IcafeAdminRedux/CouponsRedux/coponscompanyredux';
...
const addcategory = () => {
    ...
    const [UploadedFile, setUploadedFile] = useState(location?.state?.image)
    ...
    const Updatecoupon = (event) => {
        ...
        dispatch(companyUpdateCoupon(location?.state?.uuid, payload, currentUser.token))
                                ...
                                <Row className="g-3">
                                    <Col lg='6' className="mb-1">
                                        ...
                                        <Select
                                            ...
                                            defaultValue={location?.state?.store[0]?.store_name}
