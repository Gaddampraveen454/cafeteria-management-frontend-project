...
import { StoreRoleAddURL } from 'Redux/CashierRedux/StoreRoleredux/storeroleredux';
...
const addstorerole = () => {
  ...
  const AddProduct = (event) => {
    ...
    dispatch(StoreRoleAddURL(payload, currentUser.token))
    setSuc(true)
  ...
  return (
    <>
      ...
      <div className="page-title-container">
        <NavLink className="muted-link pb-1 d-inline-block hidden breadcrumb-back mb-2" to="/role_list">
          <CsLineIcons icon="chevron-left" size="20" />
          <span className="align-middle text-medium ms-1">Store Role List</span>
        </NavLink>
              ...
              <Form onSubmit={AddProduct}>
                <Row className="g-3">
                  ...
                  <Col lg="6">
                    ...
                    <Form.Control type="text" maxLength={10} minlength={10} onChange={(e) => { setMobile(e.target.value) }} />
                  </Col>
                  <Col lg="6">
