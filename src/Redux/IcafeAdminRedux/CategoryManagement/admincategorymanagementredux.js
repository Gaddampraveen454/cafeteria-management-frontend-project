...
export const { setCategoryData, setCategoryDropdown, setstoreDropdownByCompanyId, setStoreDropdown, setToast } = adminCategorySlice.actions;
...
export const ICafeAdminCategoryStoreDropDownList = (companyId) => async (dispatch) => {
    ...
    // });
    console.log(response.data, "dhbhjrjgnr")
    dispatch(setstoreDropdownByCompanyId(response.data));
